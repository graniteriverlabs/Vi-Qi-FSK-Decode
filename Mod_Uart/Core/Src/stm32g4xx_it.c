...
void DMA1_Channel1_IRQHandler(void)
{
  /* USER CODE BEGIN DMA1_Channel1_IRQn 0 */
	...
	if (__HAL_DMA_GET_FLAG(&hdma_hrtim1_a, DMA_FLAG_TC1))
	{
		__HAL_DMA_CLEAR_FLAG(&hdma_hrtim1_a, DMA_FLAG_TC1);
...
//		);
	    ...
	    /* Disable HRTIM DMA request */
	    HRTIM1->sTimerxRegs[HRTIM_TIMERINDEX_TIMER_A].TIMxDIER &=
	        ~HRTIM_TIMDIER_CPT1DE;

	    /* Abort DMA safely */
	    HAL_DMA_Abort_IT(&hdma_hrtim1_a);

		capture_done = 1;
	}
#else
	/* Half Transfer*/
    if (__HAL_DMA_GET_FLAG(&hdma_hrtim1_a, DMA_FLAG_HT1))
    {
        __HAL_DMA_CLEAR_FLAG(&hdma_hrtim1_a, DMA_FLAG_HT1);
