...
#define GRL_MAC_0      0x0070B3D5   // upper 24 bits
#define GRL_MAC_1      0x00749000   // lower 24 bits base
#define DEVICE_ID_VDPWR  0x03        // bits b11..b9 (3 bits)
#define SYSTEM_ID        0x1A9      // example: 9-bit system ID (0–0x1FF)
/**
 * MAC 1A4: static: 255.1 - Dynamic:5.84
 */
/* USER CODE END 0 */
...
void MX_ETH_Init(void)
{
  ...
  uint32_t ulUser0, ulUser1;
   ulUser0 = GRL_MAC_0;
   ulUser1 = GRL_MAC_1 | ((DEVICE_ID_VDPWR << 9) | (SYSTEM_ID & 0x1FF));

   // Extract bytes into MAC address format (Big Endian)
   MACAddr[0] = (ulUser0 >> 16) & 0xFF;   // MAC[0] = MSB of ulUser0
   MACAddr[1] = (ulUser0 >> 8)  & 0xFF;
   MACAddr[2] = (ulUser0)       & 0xFF;
   MACAddr[3] = (ulUser1 >> 16) & 0xFF;
   MACAddr[4] = (ulUser1 >> 8)  & 0xFF;
   MACAddr[5] = (ulUser1)       & 0xFF;
   heth.Init.MACAddr = &MACAddr[0];
