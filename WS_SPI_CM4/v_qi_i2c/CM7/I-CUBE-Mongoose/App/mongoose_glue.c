...
static void ota_end_timer_cb(void *arg) {
  (void) arg;
  (void) mg_ota_end();
}
...
static volatile int g_ota_end_queued = 0;
bool glue_ota_end_firmware_update(void *context) {
  (void) context;
  if (g_ota_end_queued) return true;
   g_ota_end_queued = 1;
  mg_timer_add(&g_mgr, 500, 0, ota_end_timer_cb, context);
  return true;
}
